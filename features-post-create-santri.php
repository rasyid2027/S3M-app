...
if( isset($_POST['submit']) )
{
  ...
  $stmt->execute([$name, $skill, $region]);
...
<head>
  ...
  <title>Create Santri &mdash; S3M</title>
        ...
        <section class="section">
          <div class="section-header">
            <div class="section-header-back">
              <a href="santri-data.php" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1>New Santri Data</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Santri Data</a></div>
              <div class="breadcrumb-item">New Santri Data</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Create New Santri Data</h2>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <select class="form-control selectric" name="skill_id">
                            <?php foreach( $rows as $row ) { ?>
                              <option value="<?php echo $row['sid']; ?>"><?php echo $row['sid'] . ". " . $row['skill']; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" class="form-control inputtags" name="region">
                        </div>
                      </div>
                      <div class="form-group row mb-4">
