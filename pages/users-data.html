...
<head>
  ...
  <title>Users Data &mdash; S3M</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="users-data.html"><i class="fas fa-users"></i> <span>Users</span></a></li>
            </ul>
        </aside>
      </div>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-button">
              <a href="features-post-create-users.html" class="btn btn-primary">Add New</a>
            </div>
          </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-md">
                  ...
                  <tr>
                    ...
                    <td>ear_one</td>
                    <td>Pengurus</td>
                    <td><a href="features-profile-users.html" class="btn btn-success mr-1">Edit</a><a href="#" class="btn btn-danger">Delete</a></td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td>Hasan Basri</td>
