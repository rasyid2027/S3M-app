...
<head>
  ...
  <title>Create Users &mdash; S3M</title>
        ...
        <section class="section">
          <div class="section-header">
            <div class="section-header-back">
              <a href="users-data.html" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1>New Users Data</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">User Data</a></div>
              <div class="breadcrumb-item">New Users Data</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Create New Users Data</h2>
