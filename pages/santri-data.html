        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-button">
              <a href="features-post-create-santri.html" class="btn btn-primary">Add New</a>
            </div>
          </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-md">
                  ...
                  <tr>
                    ...
                    <td>PHP</td>
                    <td>Yogyakarta</td>
                    <td><a href="features-profile.html" class="btn btn-success mr-1">Edit</a><a href="#" class="btn btn-danger">Delete</a></td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td>Hasan Basri</td>
