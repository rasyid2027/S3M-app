      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="index.html"><i class="fas fa-home"></i> <span>Home</span></a></li>
      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Welcome to Sun-3 Management app</h2>
            <p class="section-lead">Makes it easy for you to manage your santri data.</p>
            <div class="card">
