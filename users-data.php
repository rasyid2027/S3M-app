      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="active"><a class="nav-link" href="users-data.php"><i class="fas fa-users"></i> <span>Users</span></a></li>
            </ul>
        </aside>
      </div>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-button">
              <a href="features-post-create-users.php" class="btn btn-primary">Add New</a>
            </div>
          </div>
